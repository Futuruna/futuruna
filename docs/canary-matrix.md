...
| `tests/canary/interop/rust_consumer_external_crate_lib.runa` | `interop` | `runa lib` output consumed from an offline Cargo project with `@ depend`, `@ use`, raw Rust helpers, regex-backed stdlib codegen, and exported APIs |
