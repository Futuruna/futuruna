...
For bounded exploration, publication v19 and compact report v11 are current.
...
frontier and authenticated content root. The concrete reducer may reuse one
fused physical driver, but it commits choice closure before any display
projection. A
