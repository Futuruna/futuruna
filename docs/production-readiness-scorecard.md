...
| `runa from-rust` tooling | Research-grade | Keep the 35-fixture supported subset and mint-blocking downstream canary matching Rust output exactly; add a reviewed preview-boundary checklist and at least one more consumer family before preview promotion; keep stable unsupported diagnostics blocking. | L | 3 |
