...
| Expectations | Latest recorded `./scripts/expectations.sh` passed 19 cases with 1 skipped, including artifact contract fixtures. | Useful and growing; artifact snapshots now defend selected emitted Rust shapes. |
