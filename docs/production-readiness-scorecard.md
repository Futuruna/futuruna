...
| Rust interop and integration | Preview | Keep the Rust consumer canary blocking; add `@ depend`/external-crate integration canaries; freeze package-layout expectations and supported crate/import patterns. | L | 4 |
