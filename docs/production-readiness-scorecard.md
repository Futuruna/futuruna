...
| `runa from-rust` tooling | Research-grade | Keep the 35-fixture supported subset matching Rust output exactly; add downstream-style consumer checks or a reviewed preview-boundary checklist; keep stable unsupported diagnostics and CI blocking. | L | 3 |
