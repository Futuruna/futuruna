...
mod tests {
    ...
    use crate::explore::relational_journal::{RelationalEvidenceEvent, RelationalJournalContract};
    ...
    #[test]
    fn structural_assignment_gates_incidence_evidence_and_both_closures_gate_the_input_seal() {
        let source = r#"
