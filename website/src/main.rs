                ...
                section { id: "personskatteloven", class: "tax-section",
                    ...
                    div { class: "tax-status-grid",
                        div { class: "tax-status-item ready",
                            ...
                            p { "Den almindelige lønmodtagervej, flere kapitalindkomstgrene, aktieindkomst, pensionsfradrag efter Pensionsbeskatningsloven §§ 18 og 52, husdyr- og varelagerfradrag samt beløbskaskaden for § 3, stk. 2, nr. 10-11 er eksekverbare. Personaktievejen beregner nu anskaffelser, gennemsnitlig anskaffelsessum for homogene beholdninger med eller uden pålydende værdi, afståelser, noterede og unoterede tab, ægtefælleoverførsel og den afledte § 4 a-aktieindkomst. Aktie- og tegningsretter omfattet af Aktieavancebeskatningsloven § 25 følger en særskilt FIFO- og aktie for aktie-vej med § 30's afståelsesbegreb ved bortfald, 2024-overgangen og § 14's oplysningsbetingelse. Et særskilt §§ 23-27-modul håndterer realisations- og lagerprincip, den eksakte syvårsperiode, årlige lageropgørelser, principskift, MTF-rettigheder før 2024, adskilte § 7 N-beholdninger og § 27's anskaffelsessumtillæg. Blandede beholdninger med både nominel værdi og stykkapitalandele er fortsat en udtrykkelig dækningsgrænse. Afskrivningslovens kilde- og regelkorpus dækker nu hele paragrafsekvensen §§ 1-69, inklusive ophævede bestemmelser og historiske overgangsregler. §§ 50-52 håndterer næringsaktiver, forsøgs- og forskningsudgifter samt ansøgningsfrister; §§ 54-62 og 68-69 gør overgangssaldi, ældre afskrivningsgrundlag, miljøinvesteringer, udlejningsregimet og territorial afgrænsning eksekverbare. LOV 615/2026's ejendomskategorier og 2027-virkning er indarbejdet i §§ 40 C og 42. Personskatteloven § 3 modtager afledte fortjenester, afskrivninger, tab og andre fradrag som særskilte typede poster, mens § 35 fortsat peger på de oprindelige indkomstår. Andre Personskattelov-bestemmelser, afhængige love, personfradrag, underskud, delår, skatteloft, indeholdelse og slutopgørelsens yderkanter er fortsat åbne. Fuld lovdækning er stadig målet, ikke noget vi påstår er afsluttet." }
                        }
