...
fn ResearchPersonskatteloven() -> Element {
    let sections: Vec<(&str, &str, &str)> = vec![
        ...
        (
            "personskatteloven-par4-aktie-kapital.audit.runa — § 4 stk. 1 nr. 4/5/5 a/5 b LL § 16 A, Selskabsskatteloven og Aktieavancebeskatningsloven",
