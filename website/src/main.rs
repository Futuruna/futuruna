                ...
                section { id: "personskatteloven", class: "tax-section",
                    ...
                    div { class: "tax-status-grid",
                        ...
                        div { class: "tax-status-item research",
                            ...
                            p { "Personskatberegningen har nu én kildebundet kontrakt over den nåbare, typede domænegraf. Den genererede arbejdsbog har 117 typede inputkolonner plus sags-id og femten relationelle kildefaner. Variantvalg gør særlige skatteforhold, underskudsforhold, årsopgørelse og valgfri fradragsgrene eksplicitte; kun den valgte variants felter kræves. Grafen modtager nu renteindtægter, renteudgifter, Ligningslovens §§ 6/6 A-fradrag, § 9 C-befordringsfakta, valgfri § 9 D-forhold, identificerede omkostninger efter Personskattelovens § 4, stk. 2, egne og en samlevende ægtefælles ejendomsafståelser samt ordinære eller særlige ABL-forløb. Ejendomsafståelsernes skatteår, § 9 C's aftrapningsgrundlag og § 9 D-resultatet afledes af reglerne og er ikke borgerfelter. EBL §§ 5 og 5 A afleder anskaffelsessummens tillæg, udgiftsreguleringer, nedsættelser og valgfri indeksering fra kildefakta. §§ 8 og 9 afleder parcelhusfritagelsen samt bolig- og erhvervsdelingen, mens § 6 modregner egne og fremførte tab samt en samlevende ægtefælles overførte tab, før § 4, stk. 1, nr. 14-posten dannes. Overførslen begrænses til modtagerens fortjeneste efter dennes egne tab, så resten bevares til fremførsel. Værdipapirer med boligret efter EBL § 8, stk. 4, går nu gennem ABL § 15: udstederens direkte ejerskab af flerlejlighedsejendommen, boligbrug i den kvalificerende ejerperiode, eventuelt bestemt grundareal og likvidationsåret afgør fritagelsen, og et afslag fortsætter gennem de almindelige ABL-regler. Mælkekvoter, § 5, stk. 6-overførsler og § 9, stk. 4-genanbringelse er fortsat udtrykkelige fail-closed-grene; de får ingen skjult skattemæssig virkning. Fri arbejdsgiverbetalt befordring føres til personlig indkomst uden at blive gjort til AM-bidragspligtig løn. § 4, stk. 3 omklassificerer både poster og omkostninger ved næring med samme AM-afgrænsning. De resterende § 3-, § 4- og § 4 a-kildegrene kobles fortsat på samme kontrakt, så der ikke vedligeholdes et særskilt håndskrevet ark." }
                            p { "Arbejdsbogen behøver ikke være den primære brugerflade. En AI kan interviewe borgeren og bygge det typede input, mens Futuruna udfører beregningen deterministisk og bevarer den juridiske forklaringskæde. Beregningsgrænsen har den menneskelige titel `Dansk personskat`. Synlige kolonner bruger menneskelige feltetiketter, mens stabile maskinstier, interviewspørgsmål, hjælp, enheder og typede kilder ligger i kontrakten og de skjulte metadatafaner uden at ændre skattereglernes gyldighed. Det gælder nu også ABL § 15-felterne for boligret, udstederens direkte ejerskab, den kvalificerende boligperiode, grundforhold, afståelsesform og likvidationsår." }
                        }
                    }
                }
