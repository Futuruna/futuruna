                ...
                section { id: "personskatteloven", class: "tax-section",
                    ...
                    div { class: "tax-status-grid",
                        ...
                        div { class: "tax-status-item research",
                            ...
                            p { "Personskatberegningen har nu én kildebundet kontrakt med 112 nåbare definitioner. Den genererede arbejdsbog har 109 typede inputkolonner plus sags-id og ni relationelle kildefaner. Variantvalg gør særlige skatteforhold, underskudsforhold, årsopgørelse og valgfri fradragsgrene eksplicitte; kun den valgte variants felter kræves. Grafen modtager nu renteindtægter, renteudgifter, Ligningslovens §§ 6/6 A-fradrag, § 9 C-befordringsfakta, valgfri § 9 D-forhold, identificerede omkostninger efter Personskattelovens § 4, stk. 2 og ordinære eller særlige ABL-forløb. § 9 C's aftrapningsgrundlag og § 9 D-resultatet afledes af reglerne og er ikke borgerfelter. Fri arbejdsgiverbetalt befordring føres til personlig indkomst uden at blive gjort til AM-bidragspligtig løn. § 4, stk. 3 omklassificerer både poster og omkostninger ved næring med samme AM-afgrænsning. De resterende § 3-, § 4- og § 4 a-kildegrene kobles fortsat på samme kontrakt, så der ikke vedligeholdes et særskilt håndskrevet ark." }
                        }
                    }
                }
