                ...
                a { class: "research-card", href: "/research/personskatteloven",
                    ...
                    p { class: "research-card-desc",
                        "Danish personal income tax law encoded as Futuruna: source lineage, \
                         ...
                         personfradrag transfer, § 26 annual settlement plus spouse-pair transition-compensation, stk. 5/stk. 8 net-capital fixtures and stk. 6 bundfradrag transfer into the nr. 2 annual line item, and audit signals for \
            ...
            article { class: "why-main const-article tax-article",
                div { id: "overview", class: "const-intro",
                    ...
                    div { class: "tax-status-grid",
                        div { class: "tax-status-item ready",
                            ...
                            p { "Limited to checked 2025 Copenhagen/Gentofte wage-earner fixtures with shared Pengebeløb rounding and øre-fraction posture, source-backed ordinary and special-case AM-bidrag, § 1/§ 2 taxable-income composition from separate income categories, Ligningsloven §§ 9 J/9 K wage-earner deductions, municipal/church tax, § 9/§ 12 split state-personfradrag reduction order plus § 9 non-state reductions for § 8 c/kommunal/kirkelig tax, § 10 stk. 3 spouse transfer of unused personfradrag state-tax value, amount-level § 4 a pensionsfradrag in aktieindkomst, § 8 a share-income final-settlement scenarios with § 67 dividend-tax credit split, § 26 annual compensation settlement and transition-compensation fixtures including pair-level stk. 4 spouse offset, pair-level stk. 5 and stk. 8 spouse net-capital offsets, pair-level stk. 6 bundfradrag transfer into the nr. 2 annual line item, and stk. 7 spouse top-tax allocation, personal and positive-capital § 19 skatteloft inside the wage-earner breakdown, § 13 stk. 4 negative-personal-income spouse and carry-forward offset ordering wired through the reusable complex calculator, § 14 partial-year annualization through the wage-earner model using the state income-tax component after §§ 6-9, the official § 14 guidance example for annualization and one-off income handling, § 14 stk. 2 election/reversal deadline fixtures, Kildeskatteloven A-income/withholding/e-skattekort and §§ 58/60-62/62 A/62 C/67 settlement, B-skat calendar projection, B-skat minimum-rate completion plans, system-date-driven § 61 stk. 4/stk. 6 restskat rateplans with large/small installment splits, restskat timing, § 62 A interest fixtures, and overskydende skat compensation posture, BEK 839 generated card values with BEK 1094-derived 2026 indeholdelsesprocent, Opkrævningsloven payment-deadline, § 7 rate-derivation, same-year daily interest, and cross-year interest-split fixtures, 2026 Copenhagen reform-threshold wage and positive-capital fixtures with structured § 7 a/§ 8 personal tax results, 2026 Langeland high-municipal-rate § 19 personal and positive-capital fixtures checked against the published SKM Nedslag pct., a fictional household scenario, first household benefit-cliff probes for Børne- og ungeydelse plus boligsikring § 22, and synthetic § 13 complex-case breakdown fixtures." }
                        }
                ...
                section { id: "audit-signals", class: "tax-section",
                    ...
                    div { class: "const-audit-highlights tax-audit-highlights",
                        ...
                        a { href: "#audit-code",
                            span { "coverage" }
                            strong { "Shared Pengebeløb rounding, § 1/§ 2 taxable-income composition, 2026 reform with §20-derived mellemskat/topskat/toptopskat thresholds, structured § 7 a/§ 8 personal tax results, mellemskat capital branch, § 9 state and non-state personfradrag reductions, § 10 stk. 3 spouse personfradrag transfer, § 14 external annualization and stk. 2 election fixtures, personal and positive-capital § 19 calculator integration with SKM Langeland differential, ordinary and special-case AM law, Ligningsloven, municipal/church tax, Kildeskatteloven A-income/withholding/e-skattekort/slutopgørelse/restskat timing/B-skat calendar/minimumsplan/systemdato-styrede § 61 stk. 4/stk. 6 rateplans/§ 62 A interest, BEK 839 generated card values, BEK 1094 withholding percentage derivation, Opkrævningsloven payment deadlines, § 7 rate derivation, and § 7 cross-year interest split, a fictional household, household benefit cliffs, and § 13 complex calculators are executable" }
                        }
                        a { href: "#audit-code",
                            span { "cliff" }
