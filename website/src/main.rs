...
fn ResearchPersonskatteloven() -> Element {
    let sections: Vec<(&str, &str, &str)> = vec![
        ...
        (
            "ligningsloven_kapitalindkomst.runa — §§ 5 C/12 B kapitalindkomstvederlag",
        ...
        div { class: "why-page",
            ...
            article { class: "why-main const-article tax-article",
                div { id: "overview", class: "const-intro",
                    ...
                    p { class: "const-stats",
                        "47 filer \u{00B7} fælles Pengebeløb-afrunding \u{00B7} §§ 1-28 første slice \u{00B7} § 1/§ 2 skattepligtig indkomst \u{00B7} § 3 stk. 2 nr. 1 fradragsundtagelser \u{00B7} § 4 stk. 1 nr. 9 passiv virksomhed \u{00B7} § 4 stk. 1 nr. 11 udlejning \u{00B7} § 4 stk. 1 nr. 12 LL § 5 C-vederlag \u{00B7} § 4 stk. 1 nr. 13 PBL § 53 A-afkast \u{00B7} § 4 stk. 1 nr. 15 LL § 12 B-løbende ydelser \u{00B7} § 4 stk. 1 nr. 16 Afskrivningsloven § 40 C-saldo \u{00B7} § 4 stk. 1 nr. 17 fremleje fra LL § 15 Q \u{00B7} § 4 a pensionsfradrag \u{00B7} § 7 a pensionsbeløb og undtagelser \u{00B7} § 8 a/§ 67 aktieindkomst-årsopgørelse + lønmodtager §5-højt lag + negativ parslutopgørelse + fremførsel + stk. 6 negative ægtefæller \u{00B7} § 9 statslig + ikke-statslig personfradragsnedsættelse \u{00B7} § 11 negativ nettokapital i lønmodtager-slutskat \u{00B7} § 13 stk. 2 ægtefælleunderskud + egne underskud først + stk. 4 negativ personlig indkomst + § 13 a gældsordning \u{00B7} AM normal- og særtilfælde \u{00B7} kommunal/kirkelig normalberegning \u{00B7} Ligningsloven §§ 5 C/12 B + §§ 9 J/9 K/9 L/15 P/15 Q \u{00B7} Pensionsbeskatningsloven § 53 A \u{00B7} Afskrivningsloven § 40 C \u{00B7} § 14 delår/stk. 2 valg + lovniveau skatteberegning + ekstern DJV-differential \u{00B7} personlig og positiv-kapital § 19 skatteloft inkl. Langeland høj kommuneskat + SKM-nedslag \u{00B7} § 20 kildefast reguleringstal \u{00B7} Kildeskatteloven A-indkomst/A-skat/slutopgørelse/restskat-timing/B-skat/minimumsplan/systemdato-styrede § 61 stk. 4/stk. 6-rateplaner/§ 62 A \u{00B7} BEK 839 forskudskort \u{00B7} BEK 1094 indeholdelsesprocent \u{00B7} Opkrævningsloven betalingsfrister, § 7-rente og tværårssplit \u{00B7} kildefaste 2024/2025/2026 parameterpakker \u{00B7} wage-earner, delår, ekstern differential, husholdning, boligsikring, slutopgørelse, afregning, kapital og § 13 fixtures \u{00B7} audit-signaler"
                    }
                }
