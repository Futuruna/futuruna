...
const DOC_DB: &[DocEntry] = &[
    ...
    // -- String --
    DocEntry { id: "string_length", name: "string_length", oneliner: "Number of characters in a string",                                    rune: ">", rune_class: "hl-rune-gt" },
    ...
    DocEntry { id: "substring",     name: "substring",    oneliner: "Extract a portion of a string by index range",                         rune: ">", rune_class: "hl-rune-gt" },
    DocEntry { id: "char_at",       name: "char_at",      oneliner: "Get a single character from a string by index",                        rune: ">", rune_class: "hl-rune-gt" },
    DocEntry { id: "index_of",      name: "index_of",     oneliner: "Find position of a substring (\u{2212}1 if absent)",                   rune: ">", rune_class: "hl-rune-gt" },
    DocEntry { id: "string_chars",  name: "string_chars", oneliner: "Explode a string into individual characters",                          rune: ">", rune_class: "hl-rune-gt" },
