                ...
                a { class: "research-card", href: "/research/personskatteloven",
                    ...
                    p { class: "research-card-desc",
                        "Danish personal income tax law encoded as Futuruna: source lineage, \
                         ...
                         personfradrag state-tax reduction ordering, § 10 stk. 3 spouse \
                         personfradrag transfer, § 26 spouse transition-compensation fixtures, and audit signals for \
