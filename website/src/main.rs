                ...
                div { id: "overview", class: "const-intro",
                    ...
                    div { class: "tax-status-grid",
                        div { class: "tax-status-item ready",
                            ...
                            p { "Limited to checked 2025 Copenhagen/Gentofte wage-earner fixtures with shared Pengebeløb rounding and øre-fraction posture, source-backed ordinary and special-case AM-bidrag, Ligningsloven §§ 9 J/9 K wage-earner deductions, municipal/church tax, personal and positive-capital § 19 skatteloft inside the wage-earner breakdown, § 14 partial-year annualization through the wage-earner model using the state income-tax component after §§ 6-9, the official § 14 guidance example for annualization and one-off income handling, Kildeskatteloven A-income/withholding/e-skattekort and §§ 58/60-62/62 A/62 C/67 settlement, B-skat calendar projection, B-skat minimum-rate completion plans, restskat rateplans with large/small installment splits, restskat timing, § 62 A interest fixtures, and overskydende skat compensation posture, BEK 839 generated card values with BEK 1094-derived 2026 indeholdelsesprocent, Opkrævningsloven payment-deadline, § 7 rate-derivation, same-year daily interest, and cross-year interest-split fixtures, 2026 Copenhagen reform-threshold wage and positive-capital fixtures, 2026 Langeland high-municipal-rate § 19 personal and positive-capital fixtures checked against the published SKM Nedslag pct., a fictional household scenario, first household benefit-cliff probes for Børne- og ungeydelse plus boligsikring § 22, and synthetic § 13 complex-case breakdown fixtures." }
                        }
                        div { class: "tax-status-item research",
                            span { class: "tax-status-label", "Whole statute" }
                            strong { "Research/audit-only" }
                            p { "The full Personskatteloven text now has first-pass §§ 1-28 coverage, but calculation depth is incomplete: automated Nationalbank input lookup for Opkrævningsloven § 7 rates, municipal settlement/allocation, system-supported late residual restskat start dates, remaining AM edge cases, and broader external differential fixtures beyond the first § 14/§ 19 slice remain explicit gaps." }
                        }
                    }
                    p { class: "lang-note",
                        "Kildegrundlag: "
