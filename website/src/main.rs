                ...
                section { id: "personskatteloven", class: "tax-section",
                    ...
                    div { class: "tax-status-grid",
                        ...
                        div { class: "tax-status-item research",
                            ...
                            p { "Personskatberegningen har nu én kildebundet kontrakt med 124 nåbare definitioner. Den genererede arbejdsbog har 117 typede inputkolonner plus sags-id og elleve relationelle kildefaner. Variantvalg gør særlige skatteforhold, underskudsforhold, årsopgørelse og valgfri fradragsgrene eksplicitte; kun den valgte variants felter kræves. Grafen modtager nu renteindtægter, renteudgifter, Ligningslovens §§ 6/6 A-fradrag, § 9 C-befordringsfakta, valgfri § 9 D-forhold, identificerede omkostninger efter Personskattelovens § 4, stk. 2, egne og en samlevende ægtefælles ejendomsafståelser samt ordinære eller særlige ABL-forløb. Ejendomsafståelsernes skatteår, § 9 C's aftrapningsgrundlag og § 9 D-resultatet afledes af reglerne og er ikke borgerfelter. EBL § 6 modregner egne og fremførte tab samt en samlevende ægtefælles overførte tab, før § 4, stk. 1, nr. 14-posten dannes. Overførslen begrænses til modtagerens fortjeneste efter dennes egne tab, så resten bevares til fremførsel. Fortjenester under de endnu ikke fuldt modellerede EBL §§ 8/9-fritagelser afvises uden skattevirkning frem for at blive beskattet af den smallere model. Fri arbejdsgiverbetalt befordring føres til personlig indkomst uden at blive gjort til AM-bidragspligtig løn. § 4, stk. 3 omklassificerer både poster og omkostninger ved næring med samme AM-afgrænsning. De resterende § 3-, § 4- og § 4 a-kildegrene kobles fortsat på samme kontrakt, så der ikke vedligeholdes et særskilt håndskrevet ark." }
                            p { "Arbejdsbogen behøver ikke være den primære brugerflade. En AI kan interviewe borgeren og bygge det typede input, mens Futuruna udfører beregningen deterministisk og bevarer den juridiske forklaringskæde. Kontraktens kolonnestier er stabile maskinnøgler; næste generiske metadatalag skal knytte menneskelige feltetiketter, interviewspørgsmål, hjælp, enheder og kilder til de samme stier uden at gøre formuleringerne til en del af skattereglernes gyldighed." }
                        }
                    }
                }
