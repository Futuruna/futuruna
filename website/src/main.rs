                ...
                a { class: "research-card", href: "/research/personskatteloven",
                    ...
                    p { class: "research-card-desc",
                        "Danish personal income tax law encoded as Futuruna: source lineage, \
                         ...
                         personfradrag transfer, § 26 annual settlement plus spouse-pair transition-compensation, stk. 5/stk. 8 net-capital fixtures and stk. 6 bundfradrag-transfer fixtures, and audit signals for \
