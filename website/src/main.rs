                ...
                section { id: "personskatteloven", class: "tax-section",
                    ...
                    div { class: "tax-status-grid",
                        ...
                        div { class: "tax-status-item research",
                            ...
                            p { "Arbejdsbogen behøver ikke være den primære brugerflade. En AI kan interviewe borgeren og bygge det typede input, mens Futuruna udfører beregningen deterministisk og bevarer den juridiske forklaringskæde. Beregningsgrænsen har den menneskelige titel `Dansk personskat`. Synlige kolonner bruger menneskelige feltetiketter, mens stabile maskinstier, interviewspørgsmål, hjælp, enheder og typede kilder ligger i kontrakten og de skjulte metadatafaner uden at ændre skattereglernes gyldighed. Kontrakten har nu 200 eksplicitte feltmetadata-poster, herunder ejerandel, delafståelsens særskilte grundlag for hele ejendommen og delen uden bolig, alle mælkekvotefelter og § 5, stk. 6-fakta for både personen og ægtefællen, ordinær genanbringelse og kontrolophør samt ABL § 15-felterne for boligret, udstederens direkte ejerskab, den kvalificerende boligperiode, grundforhold, afståelsesform og likvidationsår. Interviewteksten gør samtidig klart, at § 5, stk. 6 er obligatorisk, når betingelserne er opfyldt." }
                        }
                    }
                }
