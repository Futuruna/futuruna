                ...
                a { class: "research-card", href: "/research/personskatteloven",
                    ...
                    p { class: "research-card-desc",
                        "Danish personal income tax law encoded as Futuruna: source lineage, \
                         ...
                         calculation fixtures through personfradrag, complex § 13 calculator \
                         fixtures, and audit signals for missing dependencies and legal cliffs."
                    }
                ...
                div { id: "overview", class: "const-intro",
                    ...
                    div { class: "tax-status-grid",
                        div { class: "tax-status-item ready",
                            ...
                            p { "Limited to checked 2025 Copenhagen/Gentofte wage-earner fixtures with shared Pengebeløb rounding and øre-fraction posture, source-backed ordinary and special-case AM-bidrag, Ligningsloven §§ 9 J/9 K wage-earner deductions, municipal/church tax, personal and positive-capital § 19 skatteloft inside the wage-earner breakdown, § 14 partial-year annualization through the wage-earner model using the state income-tax component after §§ 6-9, the official § 14 guidance example for annualization and one-off income handling, Kildeskatteloven A-income/withholding/e-skattekort and §§ 58/60-62/62 A/62 C/67 settlement, B-skat calendar projection, restskat timing, § 62 A interest fixtures, and overskydende skat compensation posture, BEK 839 generated card values with BEK 1094-derived 2026 indeholdelsesprocent, Opkrævningsloven payment-deadline, § 7 rate-derivation, same-year daily interest, and cross-year interest-split fixtures, 2026 Copenhagen reform-threshold wage and positive-capital fixtures, 2026 Langeland high-municipal-rate § 19 personal and positive-capital fixtures checked against the published SKM Nedslag pct., a fictional household scenario, and synthetic § 13 complex-case breakdown fixtures." }
                        }
                        div { class: "tax-status-item research",
                            span { class: "tax-status-label", "Whole statute" }
                            strong { "Research/audit-only" }
                            p { "The full Personskatteloven text now has first-pass §§ 1-28 coverage, but calculation depth is incomplete: automated Nationalbank input lookup for Opkrævningsloven § 7 rates, merged restskat rate schedules, municipal settlement/allocation, remaining AM edge cases, and broader external differential fixtures beyond the first § 14/§ 19 slice remain explicit gaps." }
                        }
                    }
                    p { class: "lang-note",
                        "Kildegrundlag: "
                    ...
                    p { class: "const-stats",
                        "28 filer \u{00B7} fælles Pengebeløb-afrunding \u{00B7} §§ 1-28 første slice \u{00B7} AM normal- og særtilfælde \u{00B7} kommunal/kirkelig normalberegning \u{00B7} Ligningsloven §§ 9 J/9 K \u{00B7} § 14 delår + ekstern DJV-differential \u{00B7} personlig og positiv-kapital § 19 skatteloft inkl. Langeland høj kommuneskat + SKM-nedslag \u{00B7} Kildeskatteloven A-indkomst/A-skat/slutopgørelse/restskat-timing/B-skat/§ 62 A \u{00B7} BEK 839 forskudskort \u{00B7} BEK 1094 indeholdelsesprocent \u{00B7} Opkrævningsloven betalingsfrister, § 7-rente og tværårssplit \u{00B7} 2024/2025/2026 parameterpakker \u{00B7} wage-earner, delår, ekstern differential, husholdning, slutopgørelse, afregning, kapital og § 13 fixtures \u{00B7} audit-signaler"
                    }
                }
