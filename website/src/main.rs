...
fn ResearchPersonskatteloven() -> Element {
    let sections: Vec<(&str, &str, &str)> = vec![
        ...
        (
            "ligningsloven_kapitalindkomst.runa — §§ 5 C/6/6 A/8/12 B kapitalindkomstvederlag",
