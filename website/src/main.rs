                ...
                section { id: "personskatteloven", class: "tax-section",
                    ...
                    div { class: "tax-status-grid",
                        ...
                        div { class: "tax-status-item research",
                            ...
                            p { "En almindelig erhvervsejendom kan nu bære typede genanbringelsesfakta efter EBL §§ 6 A, 6 C eller 10. Ved den senere afståelse nedsætter Futuruna anskaffelsessummen med det stadig aktive nedslag, før §§ 5 og 5 A anvendes. Den gamle fortjeneste lægges ikke særskilt til igen. Hvis bestemmende indflydelse allerede er ophørt, er nedslaget bortfaldet, og den senere afståelse bruger den ikke-nedsatte anskaffelsessum." }
