...
TD epic: `td-56cf8d`
Current implementation slice: `td-81b95e` (Kildeskattelovens § 25 A har et typet samlivsforløb med ISO-dato og særskilte årsager for separation, skilsmisse, faktisk samlivsophør og dødsfald. Ved separation eller skilsmisse skal hver kanonisk virksomhedsindtægt og -udgift være entydigt kildehenført til en periode før eller fra ophørsdatoen. Stk. 1, 7 og 8 anvendes kun på resultatet før ophøret; derefter henføres resultatet efter det dokumenterede ordinære ejerskab, mens stk. 3 fortsat er afskåret i ophørsåret. Kildeholderen, den faktiske driver før ophøret og ejeren efter ophøret kan nu være tre uafhængige roller. Scenariematricen dækker derfor både kilde hos hovedpersonen, driver hos ægtefællen og efterfølgende ejerskab hos henholdsvis hovedpersonen og ægtefællen med eksakt bevarelse af 400.000 kr. Faktisk varig adskillelse får først skattemæssig virkning ved årsskiftet, genoptaget samliv samme år bevarer helårsstatus, og en lønaftale må ikke løbe ind i ophørsdatoen. Produktionsreglerne har bestået den fortolkede og native milepæl; den udvidede rollematrice består frontend-gaten og samles med den udfyldte 303-arks rundtur ved næste publiceringscheckpoint.)
Previous implementation slice: `td-5fa241` (Kildeskattelovens § 25 A adskiller nu virksomhedens rå kildeplacering, den faktiske eller overvejende virksomhedsdriver før et samlivsophør og den ordinære ejer efter ophøret som tre selvstændige typede fakta. Stk. 1, 3 og 7 henfører resultatet til den udtrykkeligt angivne driver, mens stk. 8 kun bruger kildeplaceringen som et neutralt fordelingsanker. I et separationsår kan kildeholder, driver og efterfølgende ejer derfor skifte uafhængigt uden at flytte eller duplikere kildeposterne. Manglende driver ved stk. 1, 3 eller 7 og en angivet driver ved stk. 8 fejler lukket; kontrollen af samme driver på tværs af flere stk. 3-virksomheder bruger den faktiske driver og ikke kildeplaceringen. Alle 29 fortolkede scenarieinvarianter, den native backend på 234.434 genererede Rust-linjer og de typede metadata er verificeret. Den udfyldte 303-arks rundtur er fortsat samlet til næste publiceringscheckpoint.)
