...
Previous implementation slice: `td-81b95e` (Kildeskattelovens § 25 A har nu et typet samlivsforløb med ISO-dato og særskilte årsager for separation, skilsmisse, faktisk samlivsophør og dødsfald. Ved separation eller skilsmisse skal hver kanonisk virksomhedsindtægt og -udgift være entydigt kildehenført til en periode før eller fra ophørsdatoen. Stk. 1, stk. 7 og stk. 8 anvendes kun på resultatet før ophøret; derefter henføres resultatet efter det dokumenterede ordinære ejerskab. Stk. 3 er fortsat afskåret i ophørsåret, og en lønaftale må ikke løbe ind i ophørsdatoen. Faktisk varig adskillelse får først skattemæssig virkning ved årsskiftet, mens genoptaget samliv samme år bevarer helårsstatus. Dødsfald er en eksplicit, fail-closed grænse til dødsboskattelovens særskilte vederlagsregler. Fortolkede og kompilerede scenarier verificerer helårs- og delårsgrenene; den store XLSX-rundtur er bevidst udskudt til næste publiceringscheckpoint.)
