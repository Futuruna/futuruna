...
- Working estimate: about 96% complete as an executable research corpus, and
  about 91% complete as a production-grade calculator for Personskatteloven
...
- Canonical § 4 coverage reaches nr. 1, 2, 3, 3 a, 4, 5, 5 a, 5 b, 6, 7, 8,
  13, 14 and 17 through direct or composed annual results. Nr. 9-12 and 15-16
  plus § 4 a's LL § 7 N path are tracked in `td-ff038c`.
