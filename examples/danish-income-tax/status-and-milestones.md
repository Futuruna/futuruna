...
Status: first publishable Personskat corpus implemented and conformance-verified
Last updated: 2026-08-12
TD epic: `td-56cf8d`
Current publication gate: `td-620011` (Den offentlige `beregn_personskat`-kontrakt er verificeret gennem den aktuelle 1.839-arks XLSX-arbejdsbog, direkte typet JSON og JSON-hydrerede arbejdsbøger. Den udfyldte hovedarbejdsbog bestod sine strukturelle kontroller, den fulde 57-sagers JSON-korpusberegning bestod, og 32 repræsentative sager gav identiske komplette resultattræer fra direkte JSON og genereret XLSX uden diagnosticeringer. Den strenge rundtur fandt og lukkede manglende neutrale kildesamlinger i test-fixtures for kapitalindkomst, aktieindkomst, personlig indkomst og historiske KGL § 32-år. De anonymiserede årsopgørelser for 2023, 2024 og 2025 blev derefter afledt fra kildefakta, hydreret til arbejdsbøger og genberegnet til henholdsvis 306.059,58 kr., 397.091,95 kr. og 290.590,34 kr., præcis som myndighedens uafhængige resultater. Webfladen er samlet til ét dansk overblik; lovtekst, regler, scenarier og audits forbliver i Futuruna-korpusset. Fremtidige lovændringer, nye retsforhold, kildedrift og korpushygiejne er fortsat vedligeholdelse og udvidelse, men er ikke blokeringer for den første publicerbare model.)
Previous implementation slice: `td-50b82a` (Den kanoniske § 14-beregning sammensætter nu hele den efterfølgende skatteorden uden et aggregat-shortcut. § 7-skatten bruger det samlede personlige og positive kapitalgrundlag, årets § 13-nedsættelse indgår i helårsskatten efter §§ 6-9, og § 11-nedslaget genanvender lovens egen modregningsrækkefølge efter den komponentvise delårsnedsættelse. DIS-indkomst har sin egen identificerede § 14-kilde, så både delårs- og helårsgrundlag er synlige; Sømandsbeskatningslovens § 5-lempelse genberegnes over ni eksakte skattekomponenter, henført skatteloft og tilgængelig skat. DIS anvendes før LL §§ 33/33 A, hvorefter aktuelle og fremførte negative aktieskatter, AMBL § 6-kredit og AL § 40 C-acontoskat føres gennem den ordinære årsopgørelse. Endelig arbejdsudlejebeskatning holdes fortsat uden for den ordinære slutskat, men udstilles i det samlede topniveau ligesom i `beregn_personskat`. Skatteloftsnedslaget begrænses til den ordinære statsskat, før den endelige aktieindkomstskat lægges til. Resultatet bevarer beregnet, anvendt og ubrugt lempelse med eksakte bevarelsesidentiteter. Toogtyve eksekverbare § 14-invarianter består fortolket og via genereret native kode; backendkontrollen og det typede kontraktskema består. Alle 185 scenariefiler bestod med seks workers på 1.231,1 sekunder før den afsluttende isolerede skatteloftsrettelse; den berørte graf bestod derefter frontend, fortolket, backend og native. Den fulde 303-arks XLSX-rundtur og den afsluttende publiceringsgennemgang var på dette tidspunkt de resterende checkpoints.)
Previous implementation slice: `td-77a06c` (Den kanoniske § 14-grænse understøtter nu sammensatte helårsforløb gennem et typet, komplet `PersonskatInput` for både delåret og helåret. Det gør ægtefælleoverførsler og dokumenterede fremførte underskud beregnelige i den samme regelgraf uden at omgå de almindelige Personskat-regler. Aktieindkomst og CFC-indkomst har egne identificerede kilder og egne § 14-skattekomponenter; aktieindkomst bevares som engangsindtægt i overensstemmelse med Den juridiske vejledning C.F.1.6.2.2, mens CFC-beløb kan få et dokumenteret retvisende helårsgrundlag. Den eksakte kanoniske hovedskat bevares nu i `PersonskatBeregningResultat`, og hver stats-, kommune- og kirkeskat samt begge skatteloftsnedslag skal fortsat rekonstruere helårsskatten før delårsnedsættelsen. En almindelig årsopgørelse genberegnes med den faktiske § 14-slutskat, så indeholdt A- og B-skat afregnes mod det justerede beløb. DIS-lempelse, LL §§ 33/33 A, negativ aktieskat, AMBL § 6-kredit, AL § 40 C-acontoskat, et aktuelt § 13-underskud og § 11-nedslag er fortsat eksplicit fail-closed, indtil deres post-§ 14-grundlag kan henføres uden et aggregat-shortcut. Tretten fokuserede § 14-invarianter består fortolket og via genereret native kode; hovedkontrakten og den samlede auditgraf består frontend-kontrollen. `beregn_personskat_delår` genererer fortsat et typet kontraktskema og når 10.251 callable-familier. Den kostbare samlede auditkørsel og 185-filers scenariesuite er bevidst reserveret til næste milepæl.)
Previous § 14 core slice: `td-172450` (Personskattelovens § 14 er nu en kanonisk delårsberegning i `personskat-par14.calculate.runa`. `beregn_personskat_delår` tager den eksisterende `PersonskatInput` sammen med typet skattepligtsændring, ISO-datoer, stk. 2-valg og identificerede indkomstkilder. Hver kilde angiver sin juridiske helårsmetode: løbende beløb omregnes efter de faktiske dage i skatteåret, engangsbeløb bevares, og dokumenterede retvisende helårsbeløb kan anvendes. Hver stats-, kommune- og kirkeskat samt hvert skatteloftsnedslag nedsættes særskilt efter sit tilsvarende personlige, kapital- eller skattepligtige indkomstgrundlag, jf. cirkulære nr. 22 af 9. december 1986, afsnit J, nr. 90. Komponenternes helårsbeløb skal rekonstruere den eksakte kanoniske helårsskat, før resultatet kan være gyldigt. Stk. 2 bruger faktiske helårsbeløb og periodens tilsvarende andele; valg og omvalg valideres mod fristen den 30. juni i det andet kalenderår efter indkomståret. Den gældende stk. 3-gren bruger Kildeskattelovens § 10, stk. 5, mens den tidligere stk. 6-gren er dateret historisk efter LOV nr. 1564 af 12. december 2023. Arbejdsmarkedsbidraget forbliver periodens faktiske bidrag, og ejendomsskatter omregnes ikke. Ugyldige perioder, datoer, dubletter, uafstemte kilder, komponentafvigelser og endnu ikke sammensatte særregimer fejler lukket. Den forenklede aggregerede lønmodtagergren er fjernet, så der kun findes én autoritativ § 14-beregningsvej. Ni fokuserede scenarier består fortolket og via genereret native kode; kommunegrænsen, kompatibilitetsscenariet og bomb-auditten består fortolket, alle berørte filer består frontend-kontrollen, og calculate-skemaet regenereres med danske typede spørgsmål og kildetabeller. Den batchede suite på 185 scenariefiler bestod efter komponentrefaktoren på 1.216,9 sekunder; efter den afsluttende fjernelse af den gamle API blev kun de berørte fokustests gentaget. Den uændrede helårsregel `beregn_personskat` er fortsat byte-identisk.)
...
Previous implementation slice: `td-51cc9b` (Aktieavancebeskatningslovens § 23 er nu en kildebaseret årlig lageropgørelse i den kanoniske `beregn_personskat`-graf. Personskat modtager principfakta, opgørelsesdato, aktivklassifikation, valg, primo- og ultimoværdi, årets anskaffelser og afståelser samt § 17-modprøven og afleder selv både § 23-princippet og det fulde ABL-årsresultat. En usolgt § 19 B-beholdning, der stiger fra 100.000 kr. til 120.000 kr., giver 20.000 kr. i aktieindkomst; en tilsvarende § 19 C-beholdning, der stiger til 112.000 kr., giver 12.000 kr. i kapitalindkomst. Det typede § 23-årsresultat bevares som revisionsspor. Forkert indkomstår, et realisationsbeskattet aktiv og § 22's særskilte Kursgevinstlov-rute fejler lukket uden skattebidrag. De fem fokuserede invarianter består fortolket, alle 181 scenariefiler består med seks workers på 158,0 sekunder, og frontend-, formaterings- og metadata-stilgaten består. Beregningsskemaet genereres med 2.026 nåbare definitioner og 6.948 feltmetadata, herunder 124 danske § 23-stier for hovedperson og ægtefælle. Den fulde 303-arks rundtur er fortsat et publiceringscheckpoint og blev ikke kørt for denne udviklingsslice.)
Previous implementation slice: `td-b6ab10` (Den kanoniske Personskat-grænse afviser nu, at samme udstederidentifikation klassificeres samtidig som et aktiebaseret minimumsbeskattet investeringsbevis efter Aktieavancebeskatningslovens § 21 og som et obligationsbaseret minimumsbeskattet investeringsbevis efter § 22 for samme person og indkomstår. Et typet rutespor bevarer begge beholdningsidentifikationer og udstederidentiteten i et eksplicit konfliktresultat; konflikten gør kapitalindkomstinputtet ugyldigt og undertrykker Kursgevinstlov-grenens skattebidrag, mens det rå § 22-resultat bevares til revision. Forskellige udstedere er fortsat gyldige, og identiske udstederidentiteter hos hver sin ægtefælle sammenblandes ikke. Tre nye scenarier udvider beholdningssuiten til 13 kildebaserede invarianter, som består både fortolket og native. Alle 181 scenariefiler består med seks workers på 156,9 sekunder. Frontend, skema, typet metadata, rækkevidde og metadata-stilgaten består; skemaet har 2.023 nåbare definitioner og 6.824 feltmetadata, metadataindekset har nul diagnosticeringer, og den statiske graf indlæser 118 kilder og når 9.908 af 11.559 callable-familier. Den fulde 303-arks rundtur er fortsat et publiceringscheckpoint og blev ikke kørt for denne udviklingsslice.)
Previous implementation slice: `td-2f0046` (Aktieavancebeskatningslovens §§ 21, 26 og 27 og § 22's Kursgevinstlov-gren deler nu ét identificeret årligt beholdningsforløb for investeringsbeviser. Åbningsgrundlaget er enten en direkte dokumenteret position med anskaffelsesdato eller det fulde § 27-forløb; hver afståelse har stabil identifikation, fælles `Dato`, dagsrækkefølge, kapitalmængde, afståelsessum og oplysningsstatus. Den eksisterende § 26-fordeling forbruger kun anskaffelsessummen for den faktisk afståede mængde og bevarer resten til næste afståelse. Ti andele med 10.000 kr. i oprindelig anskaffelsessum og 2.000 kr. i § 27-tillæg fordeler derfor 4.800 kr. til et salg af fire andele for 8.000 kr. og 3.600 kr. til et senere salg af tre andele for 5.000 kr.; gevinsterne er 3.200 kr. og 1.400 kr., mens tre andele og 3.600 kr. i anskaffelsessum består. En effektiv § 21-klassifikation fører de 4.600 kr. til aktieindkomst. En effektiv § 22-klassifikation fører præcis samme beholdningsspor til Kursgevinstlovens fælles årsnetto og bevarer både to revisionsbare delopgørelser og ét samlet ABL-årsresultat på beholdningsidentiteten til § 32-modregningen. Dublerede beholdninger eller afståelser, samme udsteder kunstigt opdelt på flere beholdningsidentiteter, overafståelse, omvendt kronologi, et § 27-tillæg efter første afståelse og forkert § 21/§ 22-klassifikation fejler lukket. Beregningskontrakten udleder 45 danske feltmetadata for den direkte nye hovedpersonsgren og genbruger de typede aktivmasse- og § 27-felter; hele skemaet har 6.824 feltmetadata og metadataindekset har nul diagnosticeringer. Den statiske graf indlæser 118 kilder og når 9.902 af 11.553 callable-familier med alle nye beholdnings-, § 21-, § 22- og § 32-familier nået fra `beregn_personskat`. Ti fokuserede invarianter består fortolket og native, alle 181 scenariefiler består med seks workers på 160,8 sekunder, og alle 394 `runa`-compilertests består. Anvendelsen rettede samtidig compilerens liste-returinferens for et rekursivt regelkald på den ene side af `concat`, begrænset til den uløste operand. Den fulde 303-arks rundtur er fortsat et publiceringscheckpoint og blev ikke kørt for denne udviklingsslice.)
Previous implementation slice: `td-c1a823` (Aktieavancebeskatningslovens § 27 er nu et genbrugeligt, identificeret og dateret anskaffelsessumsforløb for andele i investeringsinstitutter med minimumsbeskatning. Den gældende lovbekendtgørelse nr. 1098 af 27. august 2025 står ordret ved reglerne. Et manglende effektivt udbetalt minimumsindkomstbeløb føres som tillæg til den oprindelige andels anskaffelsessum på tidspunktet for den årlige regnskabsgodkendelse, dog senest 30. juni året efter minimumsindkomståret; instituttets identitet, fondsklassifikation, stk. 2-betingelse, den oprindelige andels anskaffelsesdato og den lovligt afledte tillægsdato valideres før forløbet kan anvendes. Hændelserne har stabile identiteter, fælles `Dato` og eksplicit rækkefølge på samme dag, og både identiteterne og de årlige minimumsindkomstnøgler skal være entydige. Forløbet sammensættes med den korrekte § 21-gren for aktiebaserede minimumsbeskattede investeringsbeviser og ikke med ordinære aktier. Ti andele med 10.000 kr. i anskaffelsessum får et tillæg på 2.000 kr.; et efterfølgende salg af fem andele for 8.000 kr. henfører 6.000 kr. i anskaffelsessum og giver 2.000 kr. i gevinst og 540 kr. i aktieindkomstskat, mens fem andele med 6.000 kr. i anskaffelsessum består. Otte adversariale konfigurationer afviser forkert institut, omvendt kronologi, dubleret hændelsesidentitet, dubleret minimumsindkomstår, forkert tillægsdato, for sen oprindelig anskaffelse samt tillæg efter eller senere samme dag som afståelsen. Ordinære aktiehændelser har samtidig fået den samme identificerede datokappe, så år, kronologi, dubletter og § 44-datoer valideres i den kanoniske årsgren. Alle 180 scenariefiler består med seks workers; de ni fokuserede § 27-invarianter består fortolket og native, kontraktskemaet har 88 løste § 27-stier, metadataindekset har nul diagnosticeringer, og den statiske graf når 9.856 af 11.505 callable-familier med samtlige § 27-beregningsfamilier nået fra `beregn_personskat`. Den separate § 22/KGL-gren skal genbruge samme anskaffelsessumsforløb i en senere slice. Fortolkede fokustests og seks-worker-scenarier er den løbende gate; native kompilering reserveres til berørte milepæle, og den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-8f99ce` (Afskrivningslovens § 45-fordelinger bindes nu til stabile aktividentifikationer i stedet for alene at blive kontrolleret på aktivkategori. § 16 etablerer identiteten for § 17-forløbet, § 19 bærer særskilte identiteter for bygningen og en eventuel ejerboligpost, og § 21 bevarer identiteten i den nedskrevne værdi. En fordelt kontantværdi skal derfor matche både kategori og den præcise individuelle fordelingsnøgle, før beløbet kan blive afskrivningsgrundlag, arealfordelt anskaffelsessum eller salgssum; det kombinerede §§ 17/19-forløb kræver desuden samme bygningsidentifikation i begge retsgrundlag. Et adversarialt scenarie med en hotelbygning og en lagerbygning i samme gyldige skriftlige aftale viser, at lagerets § 45-post ikke kan føres gennem hotellets §§ 17, 19 eller 21 eller nå den kanoniske Personskat-aggregation, og intervalscenariet afviser særskilt modstridende §§ 16/19-identiteter. Allerede kontantomregnede direkte beløb bevarer en eksplicit kompatibilitetsgren. Otte berørte scenariefiler består parallelt, og det fokuserede scenarie består både fortolket og native. Hele Personskat-grafen består frontend-kontrollen og kontraktskemaet; nye identitetsfelter har danske spørgsmål og kildeankre i det typede AI-interviewskema, metadataindekset har nul diagnosticeringer, og den statiske graf når 9.795 af 11.464 callable-familier med begge identitetsregler nået fra `beregn_personskat`. Den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-b1439c` (Afskrivningslovens § 40 C er nu et typet årsforløb frem for en caller-opgjort saldo. Kildefakta består af den fysiske skatteyder, en dokumenteret primosaldoposition, aktive kvotepartier og årets kronologiske anskaffelser, vederlagsfrie overdragelser, afståelser og udløb. Reglerne validerer stabile hændelses- og aktividentifikationer, år, ejerskab, aktivgrundlag, FIFO for mælkekvoter og konsistensen mellem åbningslager og primosaldo; ugyldige hændelser muterer ikke lageret, og hele årsresultatet fejler lukket. Saldobevægelserne, den regulerede ultimosaldo og det sidste underliggende aktiv afledes herefter gennem de eksisterende § 40 C-regler. En primosaldo på 10.000 kr. og delvis afståelse for 25.000 kr. indtægtsfører 15.000 kr. og bevarer fem af ti enheder; fuld afståelse giver 15.000 kr. i fortjeneste, fuldt udløb giver 10.000 kr. i tab, og anskaffelse for 7.000 kr. efterfulgt af afståelse for 12.000 kr. giver 5.000 kr. i fortjeneste. Personskattelovens § 4, stk. 1, nr. 16, modtager nu dette aktivforløb i den kanoniske `beregn_personskat`-graf og kan ikke længere få begivenhed, saldostatus eller bevægelsesbeløb som juridiske konklusioner fra calleren. Elleve fokuserede årsforløbsinvarianter og det udvidede kanoniske scenarie består fortolket; det kanoniske scenarie består også native med uændrede 122.000 kr. i nettokapitalindkomst og 15.000 kr. fra § 40 C-grenen. Kontraktskemaet genereres med 214 løste, danske § 40 C-metadatastier på tværs af hovedperson og ægtefælle. Den statiske graf indlæser 118 kilder og når 9.794 af 11.463 callable-familier; alle nye årsforløbsregler nås fra `beregn_personskat`. Den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-d4e58d` (Afskrivningslovens § 45 er nu en genbrugelig, typet kontantværdikilde i de kanoniske bygningsforløb. §§ 17, 19 og 21 modtager enten et eksplicit allerede kontantomregnet beløb eller den fulde skriftlige § 45-fordeling; den valgte post skal findes entydigt, hele fordelingen skal afstemme med den kontantomregnede sum, og kategorien skal svare til bygningen eller installationen. § 19 kræver ved ejerboligareal en særskilt boligpost fra præcis samme § 45-fordeling og udelader den én gang før arealfordelingen. Et samlet vederlag på 1.200.000 kr. fordelt med 900.000 kr. på en hotelbygning, 200.000 kr. på en installation og 100.000 kr. på ejerboligen giver 27.000 kr. i § 17-afskrivning, 450.000 kr. i aktuelt § 19-grundlag ved 50 pct. erhvervsareal efter boligens udeladelse og 27.000 kr. i genvundne § 21-afskrivninger ved salg til 900.000 kr. En installationspost brugt som bygningsgrundlag, en ukendt aktivnøgle, en manglende boligpost og en fordeling, der mangler 100.000 kr., fejler lukket og afvises før Personskat-aggregeringen. Syv nye scenarieinvarianter, alle berørte bygnings-, interval-, afståelses-, overgangs- og kanoniske scenarier samt den fokuserede native gate består. Personskat-skemaet og metadata-stilgaten består. Den statiske graf indlæser fortsat 118 kilder og når nu 9.687 af 11.418 callable-familier; alle nye § 45-kontantværdifamilier nås fra `beregn_personskat`. En seks-worker-gate nåede de to afsluttende dybe auditfiler efter den ordinære kø; disse blev bevidst afbrudt og er udskilt som testvælgeropfølgningen `td-9b7413`. Den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-7b8729` (Aktieavancebeskatningslovens § 25-forløb for noterede aktieretter og tegningsretter er nu førsteklasses input til den ordinære ABL-årsopgørelse og den kanoniske `beregn_personskat`-graf. Årsobjektet modtager primo-FIFO-partier og årets tildelinger, køb, andre anskaffelser, afståelser og bortfald; det bevarer hele hændelsessporet, afleder selv skatteposterne og sammensætter dem med §§ 12-14. Primo-partier skal komme fra tidligere indkomstår, årets anskaffelser skal matche indkomståret, og samme selskab og rettighedsserie kan ikke deles i flere forløb og dermed omgå FIFO. Et forløb med 200 kr. i primosum, fem tildelte nulbasisrettigheder, fem købte rettigheder og salg af tolv rettigheder for 600 kr. giver 400 kr. i gevinst, 400 kr. i aktieindkomst og 108 kr. i endelig aktieindkomstskat. Et bortfald med 1.000 kr. i anskaffelsessum viser samtidig § 13 A's kildebegrænsning: uden modregningsgrundlag fremføres hele tabet i stedet for at skabe negativ almindelig aktieindkomst. Beregningskontrakten udstiller 32 danske, typede feltspørgsmål og den gældende ABL-kilde. Seks nye fokuserede invarianter og i alt 191 berørte scenarieinvarianter består fortolket; flerfilsgaten kørte med seks workers på cirka 24 sekunder. Det nye kanoniske scenarie består native, Personskat-skemaet og metadata-stilgaten består, og den statiske graf når nu 9.624 af 11.386 callable-familier. Alle § 25-beregningsfamilier nås fra `beregn_personskat`; den separate §§ 23-27-klassifikationsfacade er fortsat uden for den kanoniske beløbsgraf. Den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-65727d` (Afskrivningslovens § 33, stk. 2, er nu sammensat med den kanoniske § 5-saldo. Et typet § 5-aktivgrundlag modtager den fulde aftale-, årspositions- og anskaffelseshistorik, afleder selv § 33-resultatet og fører kun den resterende anskaffelsessum videre; andre anskaffelser i året forbliver et særskilt beløb, så de ikke kan skjule eller erstatte § 33-beregningen. Scenariets eksempelgrundlag på 3.000.000 kr. reduceres først med grundbeløbet til 1.286.500 kr.; tre års forskudsafskrivning på samlet 30 pct. henfører 385.950 kr. til aktiverne, og 100.000 kr. i forlods etableringskontoafskrivning efterlader 2.514.050 kr. til § 5. Sammen med 85.950 kr. i andre anskaffelser bliver saldoens tilgang præcis 2.600.000 kr. og årets 25-procentsfradrag 650.000 kr. Tomme, dublerede og flerårige anskaffelseslister, modstridende saldoår og negative supplerende beløb fejler lukket. Den kanoniske kildeadapter fører nu også § 5-resultatets `valg_gyldigt` videre til virksomhedens samlede inputgyldighed; den manglende kant blev fundet af native-gaten, fordi nulfradraget ellers skjulte et ugyldigt delegeret input. Alle 20 fokuserede §§ 28-37-scenarier består fortolket og native, alle 12 kanoniske erhvervspostscenarier består fortolket og native, og de 56 ordinære afskrivnings- og etableringskontoscenarier består fortsat. Afskrivningsloven består Rust-backendkontrollen, og Personskat-kontraktskemaet genereres. Den statiske graf indlæser 118 kilder og når nu 9.549 af 11.377 callable-familier; hele § 33-kæden er nået fra `beregn_personskat`. Den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-60fbd9` (Afskrivningslovens §§ 17 og 19 er nu sammensat til én årlig, kanonisk afskrivning for blandet benyttede bygninger. § 19 afleder arealandelen, 25-procentsgrænsen med 300 m²-undtagelsen, ejerboligens udelukkelse og særskilte grundlagsintervaller ved senere ændringer; hvert aktivt interval kræver derefter ét eksplicit § 17-valg, som begrænses af årets sats og intervallets resterende rum op til 100 pct. § 20 afskærer afskrivning i salgs- og andre ophørsår uden at omskrive den historiske intervalsaldo. Manglende, dublerede eller fremmede intervalvalg, ugyldig historik og modstridende aktiv-, skatteyder- eller årskontekst fejler lukket. Et grundlag på 500.000 kr. giver 15.000 kr. i 2026, en arealforøgelse til 750.000 kr. giver 22.500 kr. over to særskilte aktive intervaller, og et interval, der allerede er afskrevet 99 pct., begrænses til de sidste 5.000 kr. Ejerboligeksemplet fjerner 200.000 kr. og 200 m² før fordelingen og giver 12.000 kr. Alle ni intervalscenarier og ni kanoniske erhvervspostscenarier består; den kanoniske native gate og kontraktskemaet består. Den statiske graf indlæser 118 kilder og når nu 9.522 af 11.369 callable-familier; hele den nye §§ 17/19-kæde og det tidligere isolerede `afskrivningslov19_resultat` er nået. Letvægtsgates køres parallelt, mens den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-67f17f` (Afskrivningslovens § 10 er nu sammensat med den kanoniske § 5-saldo i stedet for at ende som et isoleret resultat uden skattevirkning. `Afskrivningslov5Aktivgrundlag` skelner typet mellem et ordinært kapitel 2-aktiv og et dok- eller beddingsanlæg efter § 10, så bygninger og installationer ikke skal fejlklassificeres som almindelige driftsmidler. Den officielle 2026-grænse på 965.800 kr., udelukkende erhvervsmæssig brug, valget af §§ 5-9, den bindende behandling af senere fortjeneste og sammenfaldende indkomstår afledes før anskaffelsessummen føres til samme saldo som virksomhedens driftsmidler og skibe. En saldo på 1.100.000 kr. giver 275.000 kr. i afskrivning, og en ren 965.800-kr.-anskaffelse giver 241.450 kr. gennem `beregn_personskat`; ugyldige betingelser giver nul, og et modstridende år afviser inputtet. Alle 56 fokuserede AL-scenarier og syv kanoniske scenarier består fortolket; de syv kanoniske scenarier består også kompileret. Den statiske graf indlæser 118 kilder og når nu 9.444 af 11.324 callable-familier; alle fem § 10-familier er nået. Den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
...
Previous implementation slice: `td-7926b4` (Dødsboskattelovens §§ 30-32 er udvidet fra et kunstigt 2025-2026-loft til den kildebelagte 2023-2026-horisont. Skatteministeriets officielle § 20-tabel bærer bofradrag/mellemperiodefradrag på 6.400/2.400 kr. i 2023 og 6.600/2.400 kr. i 2024 samt Personskattelovens § 8 a-grænser på 58.900 og 61.000 kr.; de eksisterende 27/42-procentsregler bevares. 2022 fejler fortsat lukket. Udvidelsen åbner Sømandsbeskatningslovens § 5-afhængighed i 2023: et bo med 600.000 kr. i bobeskatningsindkomst og 500.000 kr. i DIS-nettoløn får 280.800 kr. i § 30-skat før SØBL-lempelse, 234.000 kr. i forholdsmæssig lempelse og 46.800 kr. tilbage. Formatter, parallelle frontend- og fortolkergates, metadata-stil og begge fokuserede native grafer består. Den kolde store native gate tog cirka 30 sekunder og dens cache-hit 0,13 sekunder; letvægtsgates køres parallelt, mens store jobs fortsat har begrænset samtidighed. De kanoniske 2023/2024-årsopgørelser bevarer slutskatterne 30.605.958 og 39.709.195 øre uden den fulde 303-arks rundtur.)
Previous implementation slice: `td-faca30` (Kulbrinteskattelovens § 21, stk. 2, er udvidet fra et kunstigt 2025-2026-loft til den kildebelagte 2023-2026-horisont og åbner dermed Sømandsbeskatningslovens § 5 b-afhængighed i 2023-2024. LBK nr. 1820/2021 bærer den uændrede 30-procentsregel i 2023-2024; LOV nr. 502, 710 og 1564 af 2023 er kontrolleret særskilt og ændrer ikke stk. 2. LBK nr. 477/2025 bærer 2025-2026. Resultatet udstiller den typede lovversion, mens 2022/2027 fejler lukket med nul lov- og AM-sats. Et grundlag på 500.000 kr. giver i 2023-2025 150.000 kr. i endelig indkomstskat og 40.000 kr. i AM-bidrag; den eksisterende 2026-ungdomsundtagelse bevares. Fokuseret frontend, fortolker, metadata-stil og genereret Rust består, og SØBL § 5 b's 2023-afhængighed er nu beregningsklar. De kanoniske 2023/2024-årsopgørelser bevarer slutskatterne 30.605.958 og 39.709.195 øre. Parallelle letvægtsgates er fortsat hensigtsmæssige, men samtidige store native/interpreter-gates gav CPU-konkurrence; de køres derfor med begrænset samtidighed og uden den fulde 303-arks rundtur før publiceringscheckpointet.)
Previous implementation slice: `td-4ae48a` (Sømandsbeskatningslovens §§ 5-8 og bekendtgørelsens § 4 er udvidet fra et kunstigt 2025-2026-loft til den kildebelagte 2023-2026-horisont. LBK nr. 1181/2023 med den kontrollerede LOV nr. 333/2024 bærer §§ 5-8; Ligningslovens § 7 U-bundfradrag på 8.000 kr. bæres af LBK nr. 42/2023 for 2023-2025 og LBK nr. 1500/2025 for 2026. Årsresultatet udstiller begge typede lovversioner. Tomme og udfyldte år uden kildedækning fejler lukket, og ugyldige år kan ikke føre ordinær bruttoløn ind i Personskat. Et fokuseret scenarie verificerer ordinær DIS-indkomst i 2023, forholdsmæssig fordeling af 8.000 kr. mellem 20.000 kr. i direkte DIS-tilknyttet § 7 U-indkomst og 60.000 kr. i anden § 7 U-indkomst i 2024 samt grænseårene 2022/2027. Frontend, fortolker, Rust-backend og native består. Den brede §§ 5-8-matrice og de kanoniske 2023/2024-årsopgørelser består fortolket med uændrede slutskatter på 30.605.958 og 39.709.195 øre. Den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-3783b1` (Sømandsbeskatningslovens §§ 3-4 er udvidet fra et kunstigt 2025-2026-loft til den kildebelagte 2023-2026-horisont. LBK nr. 1181/2023 bærer §§ 3-4, den årlige 2023-vejledning bekræfter fradraget på 56.900 kr., og LOV nr. 333/2024 indsætter alene § 11 c uden at ændre §§ 3-4. Resultatet udstiller en typet lovversion, og både tomme og udfyldte år uden kildedækning fejler nu lukket i stedet for at blive godkendt gennem en tom-liste-undtagelse. Et selvstændigt, letvægtigt scenarie verificerer 2023-2026, 56.900/105.000 kr., halvårsfradraget på 52.500 kr., § 4-samordning og grænseårene 2022/2027 på under to sekunder native. Den fulde sømandsintegration og de kanoniske 2023/2024-årsopgørelser består fortolket med uændrede slutskatter på 30.605.958 og 39.709.195 øre. Den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-f4c121` (Ligningslovens § 9 A-rejsekæde er udvidet fra et kunstigt 2025-2026-loft til den kildebelagte 2023-2026-horisont. LBK nr. 42/2023 og LBK nr. 1500/2025 bærer den ordret identiske § 9 A samt de anvendte dele af § 9 og § 9 C; SKM2022.613.SKTST, SKM2023.613.SKTST, SKM2024.643.SKTST og SKM2025.725.SKTST bærer de årlige satser. Reglerne afleder kost- og logisatserne fra grundbeløbene 455 og 195 kr. i 2010-niveau og det fælles årsloft fra 25.000 kr. gennem Personskattelovens § 20. Resultatet udstiller lovversion, satsversion, reguleringstalskilde og alle mellemregninger. Satspakkerne er henholdsvis 555/238/30.500, 574/246/31.600, 597/256/32.800 og 625/268/34.400 kr.; en kanonisk todøgnsrejse bevarer 800 kr. i skattefri godtgørelse og giver 786, 840, 906 og 986 kr. i fradrag gennem `beregn_personskat`. Ikke-tomme input i 2022 og 2027 fejler lukket. Metadata-, formatterings-, parallelle frontend-, fortolknings- og native gates består. Den fokuserede native gate tog 2,1 sekunder; den kolde kanoniske Personskat-gate køres én gang ved sliceslut, og et uændret cache-hit tog 0,38 sekunder. Den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-3b8f6a` (Ligningslovens § 9, stk. 1 og 3, er udvidet fra et kunstigt 2025-2026-loft til den kildebelagte 2023-2026-horisont. LBK nr. 42/2023 bærer lovreglen for 2023-2025, og LBK nr. 1500/2025 bærer den for 2026. Den fælles bundgrænse kopieres ikke som et løst årstal: reglerne anvender § 9's grundbeløb på 5.500 kr. i 2010-niveau, Personskattelovens § 20-reguleringstal på 121,8, 126,1, 131,0 og 137,3 samt den eksisterende lovbestemte afrunding. Det giver de officielt publicerede grænser på 6.700, 7.000, 7.300 og 7.600 kr. for 2023-2026. Resultatet udstiller lovversion, reguleringstalskilde og hele reguleringsmellemregningen; 10.000 kr. i dokumenterede lønmodtagerudgifter giver derfor fradrag på henholdsvis 3.300, 3.000, 2.700 og 2.400 kr. gennem den kanoniske `beregn_personskat`-graf. Ikke-tomme input i 2022 og 2027 fejler lukket. Metadata-, formatterings-, frontend-, fortolknings- og native gates består. Den fokuserede native gate tager cirka to sekunder; den kolde kanoniske gate køres én gang ved sliceslut, mens den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-42a2cc` (Ligningslovens § 9 B-kæde er udvidet fra et kunstigt 2026-loft til den kildebelagte 2023-2026-horisont. LBK nr. 42/2023 bærer lovreglen for 2023-2025, LBK nr. 1500/2025 bærer den for 2026, og Skatterådets årlige bekendtgørelser bærer satser, kilometerloft og firmabilundtagelser særskilt for hvert år. Resultaterne udstiller både lov- og satsversion, mens 2022 og 2027 fejler lukket. Fire kanoniske `beregn_personskat`-scenarier verificerer direkte fradrag på henholdsvis 4.230, 4.290, 4.310 og 4.440 kr. En eksisterende samordningsfejl er samtidig rettet: et ugyldigt årsaggregat kan ikke længere nulstilles og derefter genopstå gennem LL § 9 G eller Sømandsbeskatningslovens § 4 ved genfoldning af underliggende sager. Arbejdsgangen bruger parallelle frontend-gates under redigering og én samlet native gate ved sliceslut; den fulde 303-arks rundtur forbliver et publiceringscheckpoint.)
Previous implementation slice: `td-a1661b` (Personskattelovens § 4 b-CFC-kæde er udvidet fra et kunstigt 2026-loft til den kildebelagte 2023-2026-horisont. Ligningslovens § 16 H, stk. 1, 2, 6, 7, 9 og 10, samt § 16 I, stk. 6-7, er ordret identiske i de modellerede dele af LBK nr. 42/2023 og LBK nr. 1500/2025; begge officielle kilder er typede, særskilt sporbare metadata over hver lovblok. Resultaterne udstiller den valgte regelversion: LBK nr. 42/2023 for indkomstårene 2023-2025 og LBK nr. 1500/2025 for 2026. Selskabsskattelovens § 17-sats bærer tilsvarende LBK nr. 1241/2022 for 2023-2024 og LBK nr. 279/2025 for 2025-2026. År uden for horisonten fejler lukket. Fire kanoniske `beregn_personskat`-scenarier giver hvert år 120.000 kr. i CFC-indkomst efter § 4 b og 26.400 kr. i skat efter § 8 b; 2022 og 2027 giver nul grundlag og ugyldigt CFC-input. Metadata-, frontend-, audit-, fortolknings- og native gates består, og et uændret native genkørsel bruger cache på 0,39 sekunder. Den fulde 303-arks rundtur er fortsat samlet til publiceringscheckpointet.)
Previous implementation slice: `td-091de2` (De seks offentlige beregningsentries har nu et typet og path-checket inventory over deres tidskilder. Personskattelovens § 10 bærer både LBK nr. 1284/2021 og LOV nr. 1564/2023, herunder § 7's virkning fra indkomståret 2023 og årsspecifikke retsadresser før og efter renummereringen. Ejendomsskattelovens § 22 skifter citation fra stk. 2 til stk. 1 den 1. juli 2025 uden formelændring. Aktieavancebeskatningslovens offentlige investeringsklassifikationer fejler lukket uden for den eksplicit belagte 2023-2026-horisont og bærer historisk grundtekst, ændringslove, virkningstidspunkter og gældende tekst som særskilte metadata. Fokuserede metadata-, frontend-, interpreter- og native gates består; de fire hurtige gates tog 7,9 sekunder parallelt mod 21,8 sekunders samlet seriel tid, og et native cache-hit tog 0,06 sekunder. Den fulde 303-arks rundtur er fortsat samlet til publiceringscheckpointet.)
Previous implementation slice: `td-bf5e81` (Ti flertrins-resultatkontrakter og seks offentlige resultatgrænser er inventeret på tværs af Personskatteloven, Sømandsbeskatningsloven, Ligningsloven, Ejendomsskatteloven og Kildeskatteloven. Kildebelagte auditregler kontrollerer komponentsummer, ikke-negativitet, lovbestemte nedslag, ægtefælleoverførsel, fremførsel og øre-til-kroneprojektion. De gør samtidig tringrænsen eksplicit: negativ aktieindkomstskat efter PSL § 8 a, stk. 5, bevares som en særskilt kredit efter KSL § 60, litra g, og trækkes derfor ikke også fra den kanoniske `slutskat_øre`. En ikke-nul kredit på 50.000 kr. bevarer præcis 30.000 kr. i modregning og 20.000 kr. i fremførsel, mens den virkelige 2025-årsopgørelse fortsat giver 29.059.034 øre. Audit, typede metadata, fortolkede regler og genereret Rust består; der er ikke fundet nye resultatmismatch. En fejlagtig audit-URL til SØBL § 5 er rettet til LBK nr. 1181 af 21/09/2023.)
Previous implementation slice: `td-fe8f4b` (Dødsboskattelovens § 30 afleder bofradrag, mellemperiodefradrag og det yderligere § 62-ægtefællefradrag fra daterede kildefakta. Kildeskattelovens § 22 er nu en typet afhængighedskilde: et forskudt indkomstår skal begynde den første i en måned, et bagudforskudt år kan tidligst begynde 1. marts i året før dødsåret, og et fremadforskudt år kan senest begynde 1. februar i dødsåret. Umulige datoer fejler lukket med nul afledte fradragsmåneder. Den juridiske vejledning C.E.3.3.6.2.1 er fastgjort til 2026-2. Alle 43 fokuserede scenarieinvarianter består både fortolket og native; Personskat-frontend, Rust-testkompilering og de typede metadata består. Tre direkte JSON/XLSX-regressioner er indkodet, mens den udfyldte 303-arks rundtur samles med næste publiceringscheckpoint.)
Previous implementation slice: `td-81b95e` (Kildeskattelovens § 25 A har et typet samlivsforløb med ISO-dato og særskilte årsager for separation, skilsmisse, faktisk samlivsophør og dødsfald. Ved separation eller skilsmisse skal hver kanonisk virksomhedsindtægt og -udgift være entydigt kildehenført til en periode før eller fra ophørsdatoen. Stk. 1, 7 og 8 anvendes kun på resultatet før ophøret; derefter henføres resultatet efter det dokumenterede ordinære ejerskab, mens stk. 3 fortsat er afskåret i ophørsåret. Kildeholderen, den faktiske driver før ophøret og ejeren efter ophøret kan nu være tre uafhængige roller. Scenariematricen dækker derfor både kilde hos hovedpersonen, driver hos ægtefællen og efterfølgende ejerskab hos henholdsvis hovedpersonen og ægtefællen med eksakt bevarelse af 400.000 kr. Faktisk varig adskillelse får først skattemæssig virkning ved årsskiftet, genoptaget samliv samme år bevarer helårsstatus, og en lønaftale må ikke løbe ind i ophørsdatoen. Produktionsreglerne har bestået den fortolkede og native milepæl; den udvidede rollematrice består frontend-gaten og samles med den udfyldte 303-arks rundtur ved næste publiceringscheckpoint.)
Previous implementation slice: `td-1e2380` (Kursgevinstlovens § 25-valg er nu vedvarende og kontrolleret pr. kategori for både valutapositioner og ordinære børsnoterede obligationspositioner. En videreført position bærer det foregående opgørelsesprincip, og årets angivne valghistorik skal matche både indkomstår og princip; udeladt eller modstridende historik fejler lukket på instrumentet og årsnettet og kan ikke danne et Personskat-resultat. En gyldig DKK-obligation, som steg fra 100.000 kr. til 120.000 kr. under lagerprincippet i 2025 og til 130.000 kr. i 2026, medregner derfor præcis 10.000 kr. i 2026. De fortolkede og native flerårsscenarier, den fulde Personskat-kompilering, beregningsskemaet og en ny genereret XLSX-arbejdsbog er verificeret; den udfyldte 303-arks rundtur er samlet til næste publiceringscheckpoint.)
Previous implementation slice: `td-65de02` (Ligningslovens § 33 F og Den juridiske vejledning C.F.2.3 afledes nu fra identificerede udenlandske bruttoindtægter, direkte henførbare udgifter og ikke direkte henførbare udgifter med dokumentreference og typet behandling. Hver post angiver de danske indkomstgrundlag, den faktisk indgår i, så Futuruna selv opgør særskilte nettoer for skattepligtig, personlig, positiv kapital-, aktie-, CFC- og AM-bidragsindkomst uden seks caller-beregnede nettobeløb. Negative kategorier bevares i auditresultatet, mens kun lovens positive kapital- og AM-grundlag beskæres til nul; blandede positive og negative indkomstarter kan derfor ikke forveksles med ét samlet nettobeløb. Eksportkreditrenter efter stk. 3 og øvrige fællesudgifter er særskilte kildeposter, dublerede eller ufuldstændige kilder fejler lukket, og de afledte værdier bruges direkte af de ni danske skattekomponenter. Den kanoniske Personskat-beregning, § 6-ejendomsafstemning, fragtskat og den præcise 2025-årsopgørelse er verificeret fortolket, kompileret og gennem den fulde udfyldte JSON/XLSX-rundtur; arbejdsbogen udstiller nu kildetabellerne i stedet for afledte nettotaler.)
Previous implementation slice: `td-af7aa6` (Børnebidragslovens § 19 og Bidragsbekendtgørelsens §§ 3-4 og 9-11 er et særskilt, kildebåret domæne for fødsels-, navngivnings-, barsels- og abortudgiftsbidrag. Reglerne bevarer den retlige modtager som moren eller den myndighed eller institution, der afholdt udgiften, og forveksler ikke bidragene med løbende børnebidrag. En offentlig fastsættelse kræver nu en dateret myndighedsansøgning og et typet fristgrundlag: fødslen, en faderskabs- eller medmoderskabssag indledt ved fødslen, aborten eller dokumenterede helt særlige omstændigheder. To kalendermåneder regnes inklusivt; en fødselsnær forældresag skal afsluttes senest to år efter fødslen for at opfylde kravet om bidrag fra fødslen. Private bindende aftaler holdes særskilt fra myndighedsansøgninger, og modstridende eller for sene fakta fejler lukket. Fødsels-, barsels- og abortudgiftsbidrag giver intet fradrag hos yderen; navngivningsbidrag prøves gennem Ligningslovens §§ 10-11. Den ikke udtrykkeligt kildeafklarede beskatning hos moren fejler lukket. Den kanoniske beregning, en udfyldt XLSX-rundtur og de tre virkelige årsopgørelser er verificeret.)
Previous implementation slice: `td-196df8` (Praksis til Ligningslovens §§ 10-11 skelner typet mellem hele forfaldsmånedens bidrag og et kontantbeløb, der allerede er forholdsmæssigt betalt til barnets 18-årsdag. Yderens fradrag fordeler det relevante bruttobidrag, mens modtagerens indkomst bevarer hele det faktisk modtagne kontantbeløb og kun fratrækker periodens forholdsmæssige normalbidrag. Et fuldt aprilbidrag på 1.603 kr. til et barn, der fylder 18 år den 5. april, giver derfor 1.335 kr. i personlig indkomst; et allerede forholdsmæssigt beløb på 267 kr. giver 0 kr. Begge ydergrene giver samme fradrag uden dobbelt periodisering, mens forholdsmæssighed uden for 18-årsmåneden fejler lukket. Underholds- og uddannelsesbidrag efter det fyldte 18. år medregnes fuldt til barnets personlige indkomst og giver intet fradrag hos yderen. Private løbende børnebidrag op til normalbidraget kontrolleres direkte; højere bidrag kræver en dokumenteret vejledende sammenligning eller et konkret skattemæssigt anerkendt bruttobeløb. Den kanoniske beregning og en udfyldt XLSX-rundtur verificerer både fradrag og modtagerbeskatning.)
Previous implementation slice: `td-4a61a9` (Ejendomsskattelovens §§ 23-27 og 35-45 er kildebåret og sammensat med Personskat. § 43 skelner mellem afgiver og modtager ved ægtefælleoverdragelse, længstlevendes overtagelse og skilsmisse før bodeling; en modtager uden eget 2024-grundlag får rabatten udledt fra den overtagne andels historiske vurderingsfakta. § 42 bruger særskilte hændelser for perioder, hvor boligen ikke kan tjene til bolig for ejeren, så ejerperiode og boligstatus ikke periodiseres dobbelt. Ordinær ejendomsværdiskat kan nu angives i flere adskilte intervaller, og § 15-perioden skal dag for dag svare til ejerperioden sammenholdt med § 42-hændelserne; modstridende fakta fejler lukket. En 50-procents andel modtaget 1. juli giver 27.250 øre i årets rabat, 154.500 øre før overgang og 127.250 øre efter overgang. Fortolkede og kompilerede scenarier, audit, direkte JSON, genereret og genindlæst XLSX samt de præcise 2023-2024-årsopgørelser er verificeret.)
...
Recent workbook conformance slice: `td-4727d8` (Den anonymiserede 2025-årsopgørelses kanoniske kildefakta kan nu eksporteres som en typet `PersonskatInput`, hydreres ind i den offentligt genererede Personskat-XLSX og beregnes tilbage gennem `runa call`. Direkte JSON og den udfyldte arbejdsbog giver identiske kanoniske resultater: personlig indkomst 749.936 kr., nettokapitalindkomst -36.404 kr., aktieindkomst 14.967 kr., slutskat 29.059.034 øre og 82,80 kr. i overskydende skat, hvor 82 kr. udbetales og 80 øre bevares som ikke-udbetalt afrunding. Myndighedens resultater indgår kun som testforventninger, ikke som beregningsinput.)
Recent historical conformance slice: `td-8f4016` (To yderligere private årsopgørelser er anonymiseret til kildefakta og afstemt gennem den kompilerede `beregn_personskat`: 2023 rammer 30.605.958 øre og 2024 rammer 39.709.195 øre inklusive indkomstgrundlag, fradrag, ægtefælleoverførsler og slutafregning. Det genanvendelige fund er, at tomme valgfrie domæner skal være neutrale i historiske år uden satstabeller, mens ikke-tomme ikke-understøttede input fortsat fejler lukket. De private PDF-filer er lokalt ignoreret og indgår ikke i git.)
Previous implementation slice: `td-086f45` (Ligningslovens § 9 L modtager ikke længere skatteyderens egen juridiske konklusion om afstanden til folkepensionsalderen. Futuruna afleder i stedet folkepensionsalderen fra en ISO-fødselsdato og den version af socialpensionslovens § 1 a, der gjaldt ved indkomstårets begyndelse, herunder 2015-, 2020- og 2025-ændringerne samt aldersgrænser udtrykt i halve år. Det første indkomstår med folkepensionsalder og den afledte 12- eller 32-procentsgren bevares som et typet, kildehenførbart resultat. Ugyldige datoer fejler lukket, arbejdsbogen spørger efter fødselsdato med danske feltnavne, og historiske grænser samt den præcise 2025-årsopgørelse er verificeret.)
Previous implementation slice: `td-76c15b` (Dødsboskattelovens § 31 understøtter særskilt skiftede fælles- og særboer med hver sin dokumenterede boopgørelsesskæringsdag. Begge perioder valideres fra dødsdatoen, den fælles beregning afstemmes ved den seneste af de to skæringsdage, og bobeskatningsindkomst samt aktieindkomst skal fortsat summere eksakt til det fælles beregningsgrundlag. Perioder og afstemninger udstilles særskilt i resultatet, mens en manglende eller ugyldig kildedato, en dato efter den fælles skæringsdag eller en dato før dødsfaldet fejler lukket.)
Previous implementation slice: `td-3def11` (Dødsboskattelovens § 31 beregner nu den endelige carry back-udbetaling som det mindste af den foreløbige underskuds- og aktieskat og et komplet, dokumenteret historikloft. Reglerne kræver afdødes to senest afsluttede indkomstår og, når relevant, den længstlevende ægtefælles samme år, dødsåret og fuldt omfattede boperiodeår; arbejdsmarkedsbidrag medregnes efter vejledningen, mens skat efter KSL §§ 48 E-48 F udelukkes. Særskilt skiftede fælles- og særboer afstemmes mod den samlede opgørelse og fordeler udbetalingen forholdsmæssigt eller fuldt til boet med negativ indkomstsum ved modsatte fortegn. Ufuldstændig historik og uafstemte boopgørelser fejler lukket, og Personskat-arbejdsbogen udstiller årsskatterne i en relationel tabel med danske feltnavne; en komplet JSON/XLSX-rundtur bevarer to års skattehistorik og beregner et historikloft på 80.000 kr. og en udbetaling på 60.000 kr.)
...
Current KGL § 25 completion: `td-1e2380` (typede valutapositioner adskiller kredit-/priskomponent og valutakomponent efter KGL §§ 14, 23, 25 og 42, stk. 9; både valuta- og ordinære obligationspositioner bevarer det relevante foregående § 25-valg, afviser udeladt eller modstridende valghistorik og føres gennem den kanoniske JSON/XLSX-grænse)
...
Current test-selection slice: `td-9b7413` (`runa test --kind scenario --jobs 6 examples/danish-income-tax` kører de 180 scenariefiler parallelt uden de 38 særskilte auditfiler; `--kind audit` bevarer auditpakken som en eksplicit milepæls- eller publiceringsgate, mens udeladt `--kind` fortsat kører alle `.runa`-filer som hidtil)
...
Planned scenario parallelism slice: `td-8a14e1` (kør uafhængige, rene scenarieinvarianter parallelt med deterministiske resultater; KSL § 25 A's 29 fulde Personskat-invarianter er den konkrete otte-minutters reference)
Planned compiled-parity fix: `td-30211d` (`distinct` over `Option` og andre typede strukturer skal bruge Futurunas lighed uden at kræve Rusts `Display`)
...
`td-f4f16f` har efterfølgende gjort fagforeningsrelationen eksplicit. Hver
LL § 13-betaling har fortsat sin egen identifikation og sit eget beløb, men alle
betalinger til samme forening deler en stabil foreningsidentifikation. § 9 G
kræver og anvender én kildetilknytning pr. forening, ikke pr. betaling. Derfor
fjernes to delbetalinger til fiskeriets forening samlet, også når personen har
andet arbejde uden medlemskab af en anden forening, mens et kontingent til en
reelt anden forening ved det andet arbejde bevares. Årsloftet efter § 13
genberegnes først efter filtreringen. Modstridende foreningsfakta på delbetalinger
og to forskellige arbejdstilknytninger for samme forening fejler lukket.
Beregningsskemaet og arbejdsbogen har særskilte danske etiketter for
betalingsidentifikation, foreningsidentifikation og § 9 G-tilknytningen. En
...
En yderligere primærkildekontrol af § 43 har erstattet de tidligere
ægtefællehændelser, som blot bevarede den eksisterende tilstand. Modellen
skelner nu mellem afgiver og modtager, prøver betingelserne for almindelig
ægtefælleoverdragelse, længstlevende ægtefælle og skilsmisse før bodeling og
udleder den overtagne rabat fra den overdragne andels egne historiske
2024-kildefakta. En modtager uden eget rabatgrundlag kan derfor overtage en
dokumenteret andel fra den registrerede dato. Samme tidslinje bærer nu også
§ 42-hændelser for perioder, hvor ejendommen ikke kan tjene til bolig for
...
- `kursgevinstloven.runa` exists and checks with `runa check`; it covers the
  ...
  financial contracts.
- `kursgevinstloven-aarsnetto.runa`,
  `personskat-kursgevinst-aarsnetto.scenario.runa` og
  `kursgevinstloven-valuta.scenario.runa` findes og passerer både fortolket og
  kompileret udførelse. Personskat modtager nu identificerede fordringer,
  obligationer, obligationsbaserede minimumsbeviser og gæld i fremmed valuta
...
As of 2026-08-11, the corpus should be treated as a source-backed first-slice
...
- Canonical § 4 coverage reaches nr. 1, 2, 3, 3 a, 4, 5, 5 a, 5 b, 6, 7-17
  ...
  LL § 7 N path derives the shared annual exemption and its personal, capital,
  share-income and AM effects from an ordered annual fact list.
...
- `AblIkkeMedregnetISlice`, `AblUdenforDenneSlice` and unclassified catch-all
  ...
  without an explicit unsupported result.
...
- `Par10ÆgtefælleStatsskatSag` uses product-scoped `|` rules for unused
...
- Personskattelovens § 14 er nu sammensat gennem den fulde efterfølgende
  skatteorden, herunder § 13, § 11, DIS, LL §§ 33/33 A, negative
  aktieskattekreditter, AMBL § 6, AL § 40 C og endelig arbejdsudlejeskat.
  Delårs- og helårsgrundlag samt beregnet, anvendt og ubrugt lempelse bevares
  typet. Milepælsgaten på alle 185 scenariefiler bestod; efter den afsluttende
  isolerede skatteloftsrettelse bestod den berørte graf igen fortolket, backend
  og native.
...
- Kapitalafkastordningens loft efter Virksomhedsskattelovens § 22 a, stk. 3-4,
  ...
  personlig virksomhedsindkomst eller VSO-status. For ægtefæller skal
  § 22 a-grundlagets tilstedeværelse stemme med den kanoniske relation; ellers
  bliver grenen ugyldig og udsender ingen kapitalposter.
...
- Pensionsbeskatningslovens § 14 B og Arbejdsmarkedsbidragslovens § 2,
  ...
  AM-grundlag fra udbetalingens art og oprindelse. Kanonisk input holder nu
  personlig indkomst uden nyt AM-bidrag adskilt fra den bruttostørrelse, som
  faktisk skal gennem AM-reglerne. Den genererede kontrakt har danske etiketter
  og typede kilder for alle syv § 14 B-felter. Fokuserede og kanoniske
  scenarier består, og de virkelige 2023/2024-resultater er uændrede.
- Pensionsbeskatningslovens §§ 49-49 B understøtter nu 2023-2026 med typet
  lovversionsproveniens. Den historiske § 49 sammenholdt med LOV nr. 609/2023,
  § 3, stk. 2, gør 1.300-kravet til privat arbejdsløshedsforsikring anvendeligt
  fra 2024, ikke i 2023. Ligningslovens §§ 30-31-afhængighed følger samme
  horisont og bruger de officielle årlige befordringssatser. Uden for
  kildehorisonten er resultatet ugyldigt og nul, også når bidragslisten er tom;
  et tomt 2023-input er derimod gyldigt og neutralt. De virkelige 2023- og
  2024-årsopgørelser bevarer deres eksakte slutskatter gennem hele
  `beregn_personskat`-grafen. En samtidig compilerregression sikrer, at en
  ikke-kaldbar topniveauværdi ikke kan skjule en regel med samme navn og aritet
  i genereret Rust, mens en kaldbar binding fortsat skygger som før.
...
- Ligningslovens § 9, stk. 1's bundgrænse understøtter nu 2023-2026 og
  ...
  officielle grænser på 6.700, 7.000, 7.300 og 7.600 kr., bevarer hele
  kilde- og reguleringssporet i årsresultatet og sammensætter fradraget gennem
  `beregn_personskat`. Ikke-tomme input uden for den kildebelagte horisont
  fejler lukket.
- Ligningslovens § 9 B understøtter nu indkomstårene 2023-2026 med årsspecifikke
  lov- og satsversioner, officielle kilometergodtgørelsessatser og de historiske
  firmabilundtagelser. De fire år sammensættes gennem `beregn_personskat`, mens
  2022 og 2027 fejler lukket. Samordningen med LL § 9 G og
  Sømandsbeskatningslovens § 4 respekterer nu også det samlede årsresultats
  gyldighed, så gyldige underposter ikke kan genoplive et ugyldigt aggregat.
- Børnebidragslovens § 19 er implementeret med den konsoliderede ordlyd,
  retlige roller, begivenheder, forfald, dokumenteret fastsættelse og officielle
  satser for 2023-2026. Fødsels- og barselsbidrag giver efter Den juridiske
  vejledning intet fradrag hos yderen. Abortudgiftsbidragets nulfradrag afledes
  af § 19, stk. 2 og 4, sammenholdt med Ligningslovens §§ 10-11.
  Navngivningsbidrag projiceres derimod til det eksisterende
  §§ 10-11-domæne, så både yderens fradrag og en eventuel skattemæssig henføring
  til barnet følger samme regler. § 19, stk. 4's modtager er moren eller den
  myndighed eller institution, som har afholdt udgiften; fordi de fundne
  officielle skattekilder ikke udtrykkeligt afklarer morens modtagerbeskatning,
  kan den gren ikke sammensættes endnu. En tom § 19-samling er neutral i den
  kanoniske beregning, mens et udfyldt, uafklaret modtagerinput fejler lukket.
  Otte fokuserede scenarier, tre kanoniske scenarier og en udfyldt
  JSON/XLSX-rundtur passerer. De private årsopgørelsers eksakte slutskatter for
  2023, 2024 og 2025 er uændrede, og PDF-filerne forbliver lokalt ignorerede.
...
- Sømandsbeskatningslovens §§ 5-8 og bekendtgørelse nr. 940 af 2022 er nu
  ...
  Bekendtgørelsens § 4, stk. 2 er desuden et særskilt årsresultat: direkte
  DIS-tilknyttede § 7 U-ydelser udledes fra lønfakta, anden § 7 U-indkomst
  oplyses som identificerede kildeposter, og bundfradraget på 8.000 kr. fordeles
  forholdsmæssigt og begrænses til årets samlede § 7 U-indkomst. En eventuel
  afrundingsrest placeres på den anden indkomst, så hele bundfradraget bevares.
  Det korrigerede DIS-beløb bruges identisk i skattepligtig personlig indkomst
  og lempelsesnumeratoren; resten af den anden indkomst går til det ordinære
  AM-grundlag. Fortolkede og kompilerede fokus- og Personskat-scenarier passerer.
  ...
  lempelse. Et dødsbo efter dødsboskattelovens § 1, stk. 2, beregner den
  samlede skat efter §§ 30-32 fra bobeskatningsindkomst, signeret og
  dokumenteret aktieindkomst samt de datoafledte bofradrag. Positiv og negativ
  aktieindkomst bruger 27/42-procentsatserne og årets § 8 a-grænse, som
  ...
  uafklaret dobbeltbeskatningsaftale og KSL-beskatningsvalg fejler lukket.
  SØBL's forholdsmæssige dødsbolempelse accepterer fortsat kun en
...
- Kør den udfyldte 303-arks Personskat-rundtur og den afsluttende
  publiceringsgennemgang. Kontrollér, at den nye DIS-kildetabel og de typede
  § 14-resultater kan genereres, udfyldes og genindlæses uden tab, og opdatér
  website-statussen fra udviklingskorpus til publiceringsklar reference.
- Den opdaterede kanoniske rækkevidde indlæser 118 kilder og når 9.687 af
  11.418 callable-familier. Rangér de resterende 1.731 kandidater efter reel
...
- Udskyd næste performance-lag, indtil de væsentlige resterende lovregler er
  ...
  beregningsrunner. `td-9b7413` ejer den mindre CLI-forbedring, der skal kunne
  vælge `.scenario.runa` og `.audit.runa` hver for sig under parallelle gates.
  Ingen optimering må kræve cacheannotationer i lovkoden eller ændre effekter
  og reaktiv semantik.
...
- Current slice: § 14 is composed with the canonical `PersonskatInput` through
  ...
  fails closed for invalid periods, dates, duplicates, a component-total
  mismatch, or any low-level/canonical mismatch. The subsequent ordering now
  covers current § 13, § 11, DIS relief, LL §§ 33/33 A, current and carried
  negative share-tax credits, AMBL § 6, AL § 40 C and final labour-hire tax.
  DIS has a separate identified income source and exposes both period and
  whole-year bases before its nine tax components are relieved. The tax-ceiling
  reduction is clamped against ordinary state income tax before final share tax
  is recombined. Twenty-two queried invariants cover the statutory branches,
  component factors, ordering and
  exact conservation in both the interpreter and generated native backend.
  The official guidance fixture also proves recurring-versus-one-off treatment,
  and all 185 scenario files pass the completed milestone gate.
