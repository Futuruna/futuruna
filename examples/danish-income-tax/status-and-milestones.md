...
TD epic: `td-56cf8d`
Current implementation slice: `td-76c15b` (Dødsboskattelovens § 31 understøtter særskilt skiftede fælles- og særboer med hver sin dokumenterede boopgørelsesskæringsdag. Begge perioder valideres fra dødsdatoen, den fælles beregning afstemmes ved den seneste af de to skæringsdage, og bobeskatningsindkomst samt aktieindkomst skal fortsat summere eksakt til det fælles beregningsgrundlag. Perioder og afstemninger udstilles særskilt i resultatet, mens en manglende eller ugyldig kildedato, en dato efter den fælles skæringsdag eller en dato før dødsfaldet fejler lukket.)
Previous implementation slice: `td-375054` (Dødsboskattelovens § 67, stk. 7 reducerer nu den ellers fordoblede § 32-progressionsgrænse med netop den dokumenterede del af ekstragrænsen, som allerede er anvendt ved skiftet af førstafdødes særbo. Almindelig § 62-fordobling bevares uændret, mens en uafsluttet særboskatteberegning, en tom dokumentreference eller et beløb uden for den ordinære årsgrænse fejler lukket. Ingen, delvis og fuld tidligere anvendelse samt overforbrug er verificeret fortolket og kompileret; Personskat-arbejdsbogens JSON/XLSX-rundtur bevarer de typede kildefakta og den effektive progressionsgrænse.)
