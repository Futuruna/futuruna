...
Previous implementation slice: `td-5fa241` (Kildeskattelovens § 25 A er nu sammensat ved parrets årsgrænse for ordinære virksomheder uden virksomhedsordningen. Ud over betingelserne i hver virksomhed håndhæver reglerne Den juridiske vejlednings tværgående årsvalg: en lønaftale i en del af året udelukker stk. 3 og 8 i hele året; flere fælles drevne virksomheder skal bruge samme fordelingsregel; og stk. 3 kræver samme overvejende virksomhedsdriver. Det regulerede stk. 3-loft anvendes én gang på årets samlede overførsel, ikke én gang pr. virksomhed. To overførsler på hver 160.000 kr. i 2025 summerer derfor til 320.000 kr., overskrider loftet på 282.400 kr. og fejler lukket med nul regulering af begge ægtefællers skattegrundlag. To overførsler på hver 120.000 kr. bevarer derimod præcis -240.000/+240.000 kr., og gensidige lønaftaler kan fortsat give hver ægtefælle 100.000 kr. i løn. Fortolkede og kompilerede scenarier samt en udfyldt, genindlæst XLSX-rundtur er verificeret. De tre virkelige årsopgørelser kontrolleres fortsat eksakt.)
