...
```
vault/
├── wiki/.raw/              # crawl exports, analytics, scraped pages, GSC data
├── wiki/
...
```
vault/
├── wiki/.raw/              # README, git log exports, code dumps, issue exports
├── wiki/
...
```
vault/
├── wiki/.raw/              # meeting transcripts, Slack exports, docs, emails
├── wiki/
...
```
vault/
├── wiki/.raw/              # journal entries, articles, podcast notes, voice transcripts
├── wiki/
...
```
vault/
├── wiki/.raw/              # PDFs, web clips, data files, raw notes
├── wiki/
