...
```json
{
  "id": "img-cover-7823",
  "type": "file",
  "file": "wiki/_attachments/images/example.png",
  "x": -900,
  "y": -100,
  "width": 420,
  "height": 236
...
```json
{
  ...
  "height": 290,
  "color": "6",
  "background": "wiki/_attachments/images/grid-bg.png",
...
```json
{
  "nodes": [
    ...
    },
    {
      "id": "img-icon-free",
      "type": "file",
      "file": "wiki/_attachments/images/example-icon.png",
    ...
    },
    {
      "id": "img-seo",
      "type": "file",
      "file": "wiki/_attachments/images/example-cover.png",
...
- **Wrong path format**: use `wiki/_attachments/images/file.png` not `/home/user/...` or `~/...`
